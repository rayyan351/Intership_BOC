export function Icon({ name, size = 20, strokeWidth = 2, className = "" }) {
  const paths = {
    ...
    cart: <><path d="M3 4h2l2.4 10.3a2 2 0 0 0 2 1.7h7.8a2 2 0 0 0 2-1.6L21 7H7" /><circle cx="10" cy="20" r="1" /><circle cx="18" cy="20" r="1" /></>,
    ...
    products: <><path d="m7.5 4.3 9 5.2v10.4l-9-5.2V4.3Z" /><path d="m16.5 9.5 4-2.3v10.4l-4 2.3M7.5 4.3l4-2.3 9 5.2-4 2.3" /></>,
    ...
    orders: <><path d="M6 3h12l2 4-2 14H6L4 7l2-4Z" /><path d="M4 7h16M9 11v6M15 11v6" /></>,
    branches: <><path d="M4 21V8l8-5 8 5v13M9 21v-8h6v8M7 10h.01M17 10h.01" /></>,
